...
if ( isset($_POST['ir1']) ) {
	...
	$query = 'insert into sjb_all_forum set title ="'.$title.'",
											kind="'.$kind.'",
											date="'.date('Y-m-d H:i:s').'",
											Nickname="'.$nick.'",
											password="'.$pw.'",
											content="'. nl2br(htmlspecialchars($ir1,ENT_QUOTES,'utf-8')) .'",
											ip="'.$ip.'"';
...
<div class="write_table">
	...
	<form name="tx_editor_form" id="tx_editor_form" method="post" accept-charset="utf-8">
		...
		<tr align="center">
			...
			<td>
				<input type="text" name="title" id="title" maxlength="45" class="wt_title" />
			</td>
		</tr>
		<tr align="center">
			<td colspan="2">
		...
		<tr align="center">
			<td colspan="2">
				<button id="write_bt" onclick='saveContent()'>글쓰기 완료</button>
