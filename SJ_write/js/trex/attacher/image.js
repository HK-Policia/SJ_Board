...
Trex.Attachment.Image = Trex.Class.create({
	...
	getSaveHtml: function(data) {
		return "<img src=\"" + data.imageurl + "\" class=\"txc-image\" title=\"클릭하시면 원본크기로 보실 수 있습니다.\" style=\"cursor: pointer;\" onclick=\"doImgPop('" + data.imageurl + "')\" />";
	},
	getDispHtml: function(data) {
		return "<img id=\"" + data.dispElId + "\" src=\"" + data.imageurl + "\" class=\"txc-image\"  title=\"클릭하시면 원본크기로 보실 수 있습니다.\" style=\"cursor: pointer;\" onclick=\"doImgPop('" + data.imageurl + "')\" />";
	},
